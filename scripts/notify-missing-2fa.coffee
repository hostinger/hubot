...
#   HUBOT_2FA_SERVICE the service to use
...
# Author:
#   danielechalar
DEFAULT_2FA_SERVICE = 'https://api.github.com/orgs/hostinger/members?filter=2fa_disabled'
...
show2FAInfractors = (robot,res) ->
  ...
  secFAService = process.env.HUBOT_2FA_SERVICE || DEFAULT_2FA_SERVICE
